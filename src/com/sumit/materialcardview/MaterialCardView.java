...
@DesignerComponent(
        version = 1,
        versionName = "1",
        description = "This extension allows you to create a material card view in AI2.<br> Developed By <a href=\"https://sumitkmr.com\" target =\"_blank\">Sumit</a> with <a href=\"https://community.appinventor.mit.edu/t/fast-an-efficient-way-to-build-extensions/129103\" target=\"_blank\">Fast</a>",
        iconName = "icon.png"
)
public class MaterialCardView extends AndroidNonvisibleComponent implements Component {

    private final HashMap<String, CardModel> cards = new HashMap<>();

    public MaterialCardView(ComponentContainer container) {
    ...
    @SimpleFunction(description = "Set the stroke color of the card view referenced with given id")
    public void SetStrokeColor(String id, int color) {
        getCard(id).StrokeColor(color);
    }

    @SimpleFunction(description = "Set the stroke width of the card view referenced with the given id")
    public void SetStrokeWidth(String id, int width) {
        getCard(id).StrokeWidth(width);
    }
    ...
    public class CardModel extends AndroidViewComponent implements Component, ComponentContainer {
        private final CardMaker cardView;
        ...
        public CardModel(ComponentContainer container) {
            ...
            this.cardView = new CardMaker(this.componentContainer.$context());
        ...
        private void updateCard() {
            ...
            this.cardView.setStrokeWidth(this.px2dp(this.strokeWidth));
    ...
    class CardMaker extends com.google.android.material.card.MaterialCardView {
